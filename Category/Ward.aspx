...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
     <div style="width: 100%; height: 35px; line-height: 35px; margin-bottom: 10px;">
        ...
        <div class="AdminRightItem">
            ...
            <asp:DropDownList ID="ddlDistrict" AutoPostBack="True" runat="server" Style="width: 30%; height: 28px; line-height: 28px; margin-top: 3px;" OnSelectedIndexChanged="ddlDistrict_SelectedIndexChanged"></asp:DropDownList>
