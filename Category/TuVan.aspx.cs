...
public partial class Admin_TuVan : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            this.txtSearch.Text = this.objSearchConfig.getData(Session["ACCOUNT"].ToString(), "TblTuVan", "NameTuVan");
            this.getData();
        }
    ...
    protected void btnSearch_Click(object sender, ImageClickEventArgs e)
    {
        ...
        this.objSearchConfig.setData(Session["ACCOUNT"].ToString(), "TblTuVan", "NameTuVan", this.txtSearch.Text.Trim());
        #endregion
    }
    #endregion
}