<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="TonGiaoEdit.aspx.cs" Inherits="Admin_TonGiaoEdit" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="AdminItem">
        ...
        <div class="AdminRightItem">
            <asp:TextBox ID="txtCodeTonGiao" runat="server" class="AdminTextControl"></asp:TextBox>
        </div>
    </div>
    <div class="AdminItem">
        <div class="AdminLeftItem">
        ...
        <div class="AdminRightItem">
            <asp:TextBox ID="txtNameTonGiao" runat="server" class="AdminTextControl"></asp:TextBox>
        </div>
    </div>
     <div class="AdminItem">
        <div class="AdminLeftItem">
