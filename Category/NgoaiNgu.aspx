<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="NgoaiNgu.aspx.cs" Inherits="Admin_NgoaiNgu" %>
    ...
    <div style="width: 100%;">
        <table class="DataListTableHeader" border ="0">
            <tr style ="height:40px;">
                ...
                <td class="DataListTableHeaderTdItemJustify" style="width: 36%;">Tên trình độ ngoại ngữ
                </td>
            ...
            <table class="DataListTable" border="0">
                <tr style ="height:40px;">
                    ...
                    <td class="DataListTableTdItemCenter" style="width: 3%;">
                        <a href="NgoaiNguEdit.aspx?id=<%# Eval("IDNgoaiNgu") %>">
                            <img src="../Images/Edit.png" alt=""></a>
                    </td>
                    <td class="DataListTableTdItemCenter" style="width: 3%;">
                        <a href="NgoaiNguDel.aspx?id=<%# Eval("IDNgoaiNgu") %>">
