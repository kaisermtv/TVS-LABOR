<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="KetQuaHoSo.aspx.cs" Inherits="Admin_KetQuaHoSo" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div style="width: 100%;">
        <table class="DataListTableHeader" border ="0">
            <tr style ="height:40px;">
                ...
                <td class="DataListTableHeaderTdItemJustify" style="width: 36%;">Tên kết quả hồ sơ
                </td>
    ...
    <asp:DataList ID="dtlKetQuaHoSo" runat="server" RepeatDirection="Horizontal" RepeatColumns="1"
        Width="100%">
        <ItemTemplate>
            <table class="DataListTable" border="0">
                <tr style ="height:40px;">
                    ...
                    <td class="DataListTableTdItemCenter" style="width: 3%;">
                        <a href="KetQuaHoSoEdit.aspx?id=<%# Eval("IDKetQuaHoSo") %>">
                            <img src="../Images/Edit.png" alt=""></a>
                    </td>
                    <td class="DataListTableTdItemCenter" style="width: 3%;">
                        <a href="KetQuaHoSoDel.aspx?id=<%# Eval("IDKetQuaHoSo") %>">
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-top: 5px; background-color: #fbf4f4; height: 26px;"
        ...
        <tr>
            <td style="padding-left: 6px;">
                <cc1:CollectionPager ID="cpKetQuaHoSo" runat="server" BackText="" FirstText="Đầu"
