<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="TrinhDoChuyenMonEdit.aspx.cs" Inherits="Admin_TrinhDoChuyenMonEdit" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="AdminItem">
        ...
        <div class="AdminRightItem">
            <asp:TextBox ID="txtCodeTrinhDoChuyenMon" runat="server" class="AdminTextControl"></asp:TextBox>
        </div>
    </div>
    <div class="AdminItem">
        <div class="AdminLeftItem">
        ...
        <div class="AdminRightItem">
            <asp:TextBox ID="txtNameTrinhdoChuyenMon" runat="server" class="AdminTextControl"></asp:TextBox>
        </div>
    </div>
     <div class="AdminItem">
        <div class="AdminLeftItem">
