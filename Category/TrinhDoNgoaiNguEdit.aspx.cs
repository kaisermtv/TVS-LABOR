...
public partial class Category_TrinhDoNgoaiNguEdit : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            TrinhDoNgoaiNgu objTrinhDoTinHoc = new TrinhDoNgoaiNgu();
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("TrinhDoNgoaiNgu.aspx?id=" + ret);
        }
    }
    #endregion
}