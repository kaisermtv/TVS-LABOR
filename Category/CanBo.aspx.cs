...
public partial class Admin_CanBo : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            this.txtSearch.Text = this.objSearchConfig.getData(Session["ACCOUNT"].ToString(), "TblCanBo", "NameCanBo");
            this.getData();
        }
    ...
    protected void btnSearch_Click(object sender, ImageClickEventArgs e)
    {
        ...
        this.objSearchConfig.setData(Session["ACCOUNT"].ToString(), "TblCanBo", "NameCanBo", this.txtSearch.Text.Trim());
        #endregion
    }
    #endregion
}