<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Admin.master" CodeFile="TrinhDoTinHocEdit.aspx.cs" Inherits="Category_TrinhDoTinHocEdit" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="AdminItem">
        ...
        <div class="AdminRightItem">
            ...
            <a href="TrinhDoTinHoc.aspx" class="btn btn-default">Thoát</a>
        </div>
    </div>
</asp:Content>
