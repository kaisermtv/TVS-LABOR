...
public partial class Admin_NgoaiNgu : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            this.txtSearch.Text = this.objSearchConfig.getData(Session["ACCOUNT"].ToString(), "TblNgoaiNgu", "NameNgoaiNgu");
            this.getData();
        }
    ...
    {
        this.objTable = this.objNgoaiNgu.getData(this.txtSearch.Text);
    ...
    protected void btnSearch_Click(object sender, ImageClickEventArgs e)
    {
        ...
        this.objSearchConfig.setData(Session["ACCOUNT"].ToString(), "TblNgoaiNgu", "NameNgoaiNgu", this.txtSearch.Text.Trim());
        #endregion
    }
    #endregion
}