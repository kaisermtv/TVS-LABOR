<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Admin.master" CodeFile="LoaiHinhDoanhNghiepDel.aspx.cs" Inherits="Category_LoaiHinhDoanhNghiepDel" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="panel panel-default">
        <div class="panel-heading">
            <h3 class="panel-title">XÓA LOẠI HÌNH DOANH NGHIỆP</h3>
        </div>
        <br />
        <br />
