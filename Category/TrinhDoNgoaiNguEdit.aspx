<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Admin.master" CodeFile="TrinhDoNgoaiNguEdit.aspx.cs" Inherits="Category_TrinhDoNgoaiNguEdit" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="AdminItem">
        ...
        <div class="AdminRightItem">
            ...
            <a href="TrinhDoNgoaiNgu.aspx" class="btn btn-default">Thoát</a>
        </div>
    </div>
</asp:Content>
