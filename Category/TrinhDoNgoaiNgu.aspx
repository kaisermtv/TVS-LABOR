<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Admin.master" CodeFile="TrinhDoNgoaiNgu.aspx.cs" Inherits="Category_TrinhDoNgoaiNgu" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    <asp:Repeater ID="dtlData" runat="server" EnableViewState="False">
        <HeaderTemplate>
            <table class="DataListTable">
                <tr class="DataListTableHeader" style ="height:40px;">
        ...
        <ItemTemplate>
            <tr style ="height:36px;">
                ...
                <td class="DataListTableTdItemCenter">
                    <a href="TrinhDoNgoaiNguEdit.aspx?id=<%# Eval("ID") %>">
                        <img src="/Images/Edit.png" alt=""></a>
                </td>
                <td class="DataListTableTdItemCenter">
                    <a href="TrinhDoNgoaiNguDel.aspx?id=<%# Eval("ID") %>">
    ...
    <br />
    <a href="TrinhDoNgoaiNguEdit.aspx" class="btn btn-primary">Thêm mới</a>
</asp:Content>
