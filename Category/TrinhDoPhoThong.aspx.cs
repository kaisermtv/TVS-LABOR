...
public partial class Admin_TrinhDoPhoThong : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            this.txtSearch.Text = this.objSearchConfig.getData(Session["ACCOUNT"].ToString(), "TblTrinhDoPhoThong", "NameTrinhDoPhoThong");
            this.getData();
        }
    ...
    protected void btnSearch_Click(object sender, ImageClickEventArgs e)
    {
        ...
        this.objSearchConfig.setData(Session["ACCOUNT"].ToString(), "TblTrinhDoPhoThong", "NameTrinhDoPhoThong", this.txtSearch.Text.Trim());
        #endregion
    }
    #endregion
}