<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="ChucVuEdit.aspx.cs" Inherits="Admin_ChucVuEdit" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="AdminItem">
        ...
        <div class="AdminRightItem">
            <asp:TextBox ID="txtCodeChucVu" runat="server" class="AdminTextControl"></asp:TextBox>
        </div>
    </div>
    <div class="AdminItem">
        <div class="AdminLeftItem">
        ...
        <div class="AdminRightItem">
            <asp:TextBox ID="txtNameChucVu" runat="server" class="AdminTextControl"></asp:TextBox>
        </div>
    </div>
     <div class="AdminItem">
        <div class="AdminLeftItem">
