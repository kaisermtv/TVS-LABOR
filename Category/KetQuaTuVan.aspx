<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="KetQuaTuVan.aspx.cs" Inherits="Admin_KetQuaTuVan" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div style="width: 100%;">
        <table class="DataListTableHeader" border ="0">
            <tr style ="height:40px;">
                ...
                <td class="DataListTableHeaderTdItemJustify" style="width: 36%;">Tên kết quả tư vấn
                </td>
    ...
    <asp:DataList ID="dtlKetQuaTuVan" runat="server" RepeatDirection="Horizontal" RepeatColumns="1"
        Width="100%">
        <ItemTemplate>
            <table class="DataListTable" border="0">
                <tr style ="height:40px;">
                    ...
                    <td class="DataListTableTdItemCenter" style="width: 3%;">
                        <a href="KetQuaTuVanEdit.aspx?id=<%# Eval("IDKetQuaTuVan") %>">
                            <img src="../Images/Edit.png" alt=""></a>
                    </td>
                    <td class="DataListTableTdItemCenter" style="width: 3%;">
                        <a href="KetQuaTuVanDel.aspx?id=<%# Eval("IDKetQuaTuVan") %>">
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-top: 5px; background-color: #fbf4f4; height: 26px;"
        ...
        <tr>
            <td style="padding-left: 6px;">
                <cc1:CollectionPager ID="cpKetQuaTuVan" runat="server" BackText="" FirstText="Đầu"
