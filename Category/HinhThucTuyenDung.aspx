<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="HinhThucTuyenDung.aspx.cs" Inherits="Admin_HinhThucTuyenDung" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div style="width: 100%;">
        <table class="DataListTableHeader" border ="0">
            <tr style ="height:40px;">
                ...
                <td class="DataListTableHeaderTdItemJustify" style="width: 36%;">Tên hình thức tuyển dụng
                </td>
    ...
    <asp:DataList ID="dtlHinhThucTuyenDung" runat="server" RepeatDirection="Horizontal" RepeatColumns="1"
        Width="100%">
        <ItemTemplate>
            <table class="DataListTable" border="0">
                <tr style ="height:36px;">
                    ...
                    <td class="DataListTableTdItemJustify" style="width: 15%;">
                        <%# Eval("CodeHinhThucTuyenDung") %>
                    </td>
                    <td class="DataListTableTdItemJustify" style="width: 36%;">
                        <%# Eval("NameHinhThucTuyenDung") %>
                    </td>
                    ...
                    <td class="DataListTableTdItemCenter" style="width: 3%;">
                        <a href="HinhThucTuyenDungEdit.aspx?id=<%# Eval("IDHinhThucTuyenDung") %>">
                            <img src="../Images/Edit.png" alt=""></a>
                    </td>
                    <td class="DataListTableTdItemCenter" style="width: 3%;">
                        <a href="HinhThucTuyenDungDel.aspx?id=<%# Eval("IDHinhThucTuyenDung") %>">
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-top: 5px; background-color: #fbf4f4; height: 26px;"
        ...
        <tr>
            <td style="padding-left: 6px;">
                <cc1:CollectionPager ID="cpHinhThucTuyenDung" runat="server" BackText="" FirstText="Đầu"
    ...
    <br />
    <a href="HinhThucTuyenDungEdit.aspx">
