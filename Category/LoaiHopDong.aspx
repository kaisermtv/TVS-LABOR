<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="LoaiHopDong.aspx.cs" Inherits="Admin_LoaiHopDong" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div style="width: 100%;">
        <table class="DataListTableHeader" border ="0">
            <tr style ="height:40px;">
                ...
                <td class="DataListTableHeaderTdItemJustify" style="width: 36%;">Tên loại hợp đồng
                </td>
    ...
    <asp:DataList ID="dtlLoaiHopDong" runat="server" RepeatDirection="Horizontal" RepeatColumns="1"
        Width="100%">
        <ItemTemplate>
            <table class="DataListTable" border="0">
                <tr style ="height:36px;">
                    ...
                    <td class="DataListTableTdItemCenter" style="width: 3%;">
                        <a href="LoaiHopDongEdit.aspx?id=<%# Eval("IDLoaiHopDong") %>">
                            <img src="../Images/Edit.png" alt=""></a>
                    </td>
                    <td class="DataListTableTdItemCenter" style="width: 3%;">
                        <a href="LoaiHopDongDel.aspx?id=<%# Eval("IDLoaiHopDong") %>">
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-top: 5px; background-color: #fbf4f4; height: 26px;"
        ...
        <tr>
            <td style="padding-left: 6px;">
                <cc1:CollectionPager ID="cpLoaiHopDong" runat="server" BackText="" FirstText="Đầu"
    ...
    <br />
    <a href="LoaiHopDongEdit.aspx">
        <input type="text" value="Thêm mới" class="btn btn-primary" style="width: 90px !important;" /></a>
    <a href="ListCategory.aspx">
        <input type="text" value="Thoát" class="btn btn-primary" style="width: 80px !important;" /></a>
</asp:Content>
