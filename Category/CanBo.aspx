<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="CanBo.aspx.cs" Inherits="Admin_CanBo" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div style="width: 100%;">
        <table class="DataListTableHeader" border ="0">
            <tr style ="height:40px;">
                ...
                <td class="DataListTableHeaderTdItemJustify" style="width: 36%;">Tên cán bộ
                </td>
    ...
    <asp:DataList ID="dtlCanBo" runat="server" RepeatDirection="Horizontal" RepeatColumns="1"
        Width="100%">
        <ItemTemplate>
            <table class="DataListTable" border="0">
                <tr style ="height:36px;">
                    ...
                    <td class="DataListTableTdItemCenter" style="width: 3%;">
                        <a href="CanBoEdit.aspx?id=<%# Eval("IDCanBo") %>">
                            <img src="../Images/Edit.png" alt=""></a>
                    </td>
                    <td class="DataListTableTdItemCenter" style="width: 3%;">
                        <a href="CanBoDel.aspx?id=<%# Eval("IDCanBo") %>">
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-top: 5px; background-color: #fbf4f4; height: 26px;"
        ...
        <tr>
            <td style="padding-left: 6px;">
                <cc1:CollectionPager ID="cpCanBo" runat="server" BackText="" FirstText="Đầu"
