<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="HinhThucTuyenDungDel.aspx.cs" Inherits="Admin_HinhThucTuyenDungDel" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="panel panel-default">
        <div class="panel-heading">
            <h3 class="panel-title">XÓA HÌNH THỨC TUYỂN DỤNG</h3>
        </div>
        <br />
        <br />
