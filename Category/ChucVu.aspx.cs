...
public partial class Admin_ChucVu : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            this.txtSearch.Text = this.objSearchConfig.getData(Session["ACCOUNT"].ToString(), "TblChucVu", "NameChucVu");
            this.getData();
        }
    ...
    {
        this.objTable = this.objChucVu.getData(this.txtSearch.Text);
    ...
    protected void btnSearch_Click(object sender, ImageClickEventArgs e)
    {
        ...
        this.objSearchConfig.setData(Session["ACCOUNT"].ToString(), "TblChucVu", "NameChucVu", this.txtSearch.Text.Trim());
        #endregion
    }
    #endregion
}