...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    <div style="width: auto; min-height: 400px;">
        ...
        <div class="row col-sm-12">
            ...
            <a class="btn btn-primary" style="float: right; margin-right: 40px;"  onclick="TrinhKySelect()">Trình ký</a>
            <a class="btn btn-primary" style="float: right; margin-right: 40px;" onclick="ChuyenSelect()">Đánh số</a>
            </div>
        <!-- Modal danh so -->
