<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Admin.master" CodeFile="ThamDinhTiepTuc.aspx.cs" Inherits="Labor_ThamDinhTiepTuc" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    <div style="width: 83%; float: left; margin-top:-15px!important;">
        ...
        <div class="row line">
            ...
            <div class="label2">Số tháng hưởng còn lại: </div>
            <div style="width: 20%; float: left">
                 <asp:TextBox ID="txtSoThangHuongConLai" runat="server" CssClass="form-control"></asp:TextBox>
            </div>
        </div>   
        <div class="row line">
