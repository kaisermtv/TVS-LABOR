...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    <div style="width: 83%; float: left; margin-top:-15px!important;">
        ...
        <div  class="content-left">
            <ul>
                <li><a href="#">Tháng 1 ( 30/6/2017 -> 2/7/2017)</a></li>
                <li><a href="#">Tháng 1 ( 30/6/2017 -> 2/7/2017)</a></li>
                <li><a href="#">Tháng 1 ( 30/6/2017 -> 2/7/2017)</a></li>
                <li><a href="#">Tháng 1 ( 30/6/2017 -> 2/7/2017)</a></li>
                <li><a href="#">Tháng 1 ( 30/6/2017 -> 2/7/2017)</a></li>
        ...
        <div class="content-top">
            <h4>Bạn đang khai báo việc làm tháng 1</h4>
        </div>
        ...
        <div class="panel-body1" style ="padding-top:10px; margin-top:2px;">
            <div class="row">
                ...
                <div class="list-group list-group-alternate">
                    ...
                    <a href="#" class="list-group-item" runat="server"><span class="badge1" style ="left:140px;">></span>Tải quyết định </a>
                </div>               
