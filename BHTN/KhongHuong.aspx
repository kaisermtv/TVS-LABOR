<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Admin.master" CodeFile="KhongHuong.aspx.cs" Inherits="Labor_KhongHuong" %>
    ...
    <div style="width: 16%; float: right; margin-top:-5px;">
        ...
        <div class="panel-body1" style ="padding-top:10px; margin-top:2px;">
            <div class="row">
                ...
                <asp:Button ID="btnLuu" runat="server" Text="Lưu/Duyệt" Style="width: 100% !important;margin-top:10px;" CssClass="btn btn-primary" OnClick="btnLuu_Click" />
