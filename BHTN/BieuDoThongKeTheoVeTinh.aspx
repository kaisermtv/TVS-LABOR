<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="BieuDoThongKeTheoVeTinh.aspx.cs" Inherits="Labor_BieuDoThongKeTheoVeTinh" %>
        ...
        <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-top: 10px; height: 26px;"
            ...
            <tr>
                ...
                <asp:Chart ID="Chart1" runat="server" Width="1000px" Height="400px" Palette="SeaGreen">
                    <Series>
                        <asp:Series Name="Category" ChartArea="ChartArea1" ChartType="Pie" 
                            YValuesPerPoint="2">
                        </asp:Series>
                    </Series>
                    <ChartAreas>
