...
public partial class Labor_ThamDinhTiepTuc: System.Web.UI.Page
{
    #region declare  
    public int itemId = 0;
    public string _msg="";
        ...
        if (!Page.IsPostBack)
        {
            ...
            if (itemId > 0)
            {
                ...
                if(tblTinhHuong.Rows.Count>0)
                {
                    ...
                    txtSoThangHuongConLai.Text = tblTinhHuong.Rows[0]["SoThangDuocHuongConLaiBHXH"].ToString();
