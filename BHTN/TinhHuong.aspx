...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    <div style="width: 83%; float: left; margin-top:-15px!important;">
        ...
        <div class="row line">
            ...
            <div class="label2">Nơi nhận TC BHTN:</div>
            <div style="width: 20%; float: left">
             <asp:TextBox ID="txtNoiNhanTCTN" runat="server" ReadOnly="true" CssClass="form-control"></asp:TextBox>
            </div>
        ...
        <div class="panel-body1" style ="padding-top:10px; margin-top:2px;">
            <div class="row">
                ...
                <asp:Button ID="btnTinhHuong" runat="server" Text="Tính hưởng" Style="width: 100% !important; margin-top:10px;" CssClass="btn btn-primary" OnClick="btnTinhHuong_Click" />
                 ...
                 <asp:Button ID="btnChuyenTraHoSo" runat="server" Text="Chuyển trả hồ sơ" Style="width: 100% !important;margin-top:10px;" CssClass="btn btn-primary" data-toggle="modal" data-target="#LyDoTraHoSo" OnClick="btnChuyenTraHoSo_Click" />
    ...
    <div id="lichthongbao" class="modal fade" role="dialog">
     ...
     <div id="log" class="modal fade" role="dialog">
       ...
       <div id="LyDoTraHoSo" class="modal fade" role="dialog">
        <div class="modal-dialog" style="width:60%;">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                <asp:TextBox ID="txtLyDoTra" runat="server" TextMode="MultiLine" Width="100%" Height="200px"></asp:TextBox>
                <br />
                <br />
                <asp:Button ID="btnLuuLog" runat="server" OnClick="btnLuuLog_Click" CssClass="btn btn-primary" Text="Lưu" />
                </div>
                <div class="modal-footer">                 
                </div>
            </div>
