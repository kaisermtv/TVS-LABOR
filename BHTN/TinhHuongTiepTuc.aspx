<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Admin.master" CodeFile="TinhHuongTiepTuc.aspx.cs" Inherits="Labor_TinhHuongTiepTuc" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    <div style="width: 83%; float: left; margin-top:-15px!important;">
        ...
        <div class="row line ">
            <div class="label1">Số tháng được hưởng còn lại: </div>
            <div style="width: 20%; float: left">
