<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="DanhSachBaoLuu.aspx.cs" Inherits="Labor_DanhSachBaoLuu" %>
        ...
        <asp:Repeater ID="dtlData" runat="server" OnItemCommand="dtlData_ItemCommand" OnItemDataBound="dtlData_ItemDataBound">
            <HeaderTemplate>
                <table class="DataListTable" border="0" style="width: 100%; margin-top: 10px;">
                    <tr style="height: 40px;" class="DataListTableHeader">
                        ...
                        <td class="DataListTableHeaderTdItemJustify" style="width: 10%;">Sổ BHXH</td>                                  
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <a href="ThongTinBaoLuu?ID=<%# Eval("IDNLDTCTN")%>">
                        <img src="/Images/edit.png" alt="Bảo lưu" title ="Bảo lưu"></a>                
                    </td>
                </tr>
            </ItemTemplate>
            <FooterTemplate>
            ...
            <tr>
                <td style="padding-left: 6px;">
                    <cc1:CollectionPager ID="cpData" runat="server" BackText="" FirstText="Đầu"
                        ...
                        PageNumbersSeparator="&nbsp;" PagingMode="QueryString" QueryStringKey="Page">
                    </cc1:CollectionPager>
                </td>
            </tr>
        </table>
