<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Admin.master" CodeFile="ThongTinBaoLuu.aspx.cs" Inherits="Labor_ThongTinBaoLuu" %>
    ...
    <div style="width: 83%; float: left; margin-top:-15px!important;">
        ...
        <div class="row line">
            ...
            <div style="width: 52%; float: left">
                <asp:TextBox ID="txtNoiThuongTru" runat="server" ReadOnly="true" CssClass="form-control"></asp:TextBox>
            </div>
        ...
        <div class="row line">
            ...
            <div style="width: 52%; float: left">
                <asp:TextBox ID="txtChoOHienTai" runat="server"  ReadOnly="true" CssClass="form-control"></asp:TextBox>
            </div>
        </div>
        <div class="row line">
            <div class="label1">Số tháng hưởng TCTN: </div>
            <div style="width: 20%; float: left">
                 <asp:TextBox ID="txtSoThangHuong" runat="server" ReadOnly="true" CssClass="form-control"></asp:TextBox>
            </div>
            <div class="label2">Tháng lẻ bảo lưu:</div>
            <div style="width: 20%; float: left">
                 <asp:TextBox ID="txtThangLeBaoLuu" runat="server" ReadOnly="true" CssClass="form-control" ></asp:TextBox>
            </div>
        </div>   
        <div class="row line">
            <div class="label1">Hưởng từ ngày: </div>
            <div style="width: 20%; float: left">
                 <asp:TextBox ID="txtHuongTuNgay" runat="server" ReadOnly="true" CssClass="form-control"></asp:TextBox>
            </div>
            <div class="label2">Đến ngày: </div>
            <div style="width: 20%; float: left">
                 <asp:TextBox ID="txtHuongDenNgay" runat="server" ReadOnly="true" CssClass="form-control"></asp:TextBox>
            </div>
        </div>
     
        <div class="row line ">
            <div class="label1">Đã hưởng: </div>
            <div style="width: 20%; float: left">
                 <asp:TextBox ID="txtDaHuong"  runat="server" CssClass="form-control"  TextMode="Number"></asp:TextBox>
            </div>
            <div class="label2">Tháng đóng BL: </div>
            <div style="width: 20%; float: left">
                 <asp:TextBox ID="txtThangDongBaoLuu"  runat="server" CssClass="form-control"  TextMode="Number"></asp:TextBox>
            </div> 
        </div>

         <div class="row line ">
            <div class="label1">Tháng hưởng BL: </div>
            <div style="width: 20%; float: left">
                 <asp:TextBox ID="txtThangHuongBaoLuu"  runat="server" CssClass="form-control"  TextMode="Number"></asp:TextBox>
            </div>
            <div class="label2">Tổng tháng BL: </div>
            <div style="width: 20%; float: left">
                 <asp:TextBox ID="txtTongThangBaoLuu"  runat="server" CssClass="form-control"  TextMode="Number"></asp:TextBox>
            </div> 
        </div>
        ...
        <div class="row line">
            <div class="label1">Ngày đề nghị: </div>
            <div style="width: 20%; float: left">
                  <div class='input-group date' style="margin-left: 0px; width: 100% !important; float: right;">
