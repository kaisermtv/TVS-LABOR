...
public partial class Labor_ChonQuocGia : System.Web.UI.Page
{
    ...
    private void getData()
    {
        ...
        cpQuocGia.MaxPages = 1000;
        cpQuocGia.PageSize = 12;
        cpQuocGia.DataSource = this.objTable.DefaultView;
        cpQuocGia.BindToControl = dtlQuocGia;
        dtlQuocGia.DataSource = cpQuocGia.DataSourcePaged;
        dtlQuocGia.DataBind();
