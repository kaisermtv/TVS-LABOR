...
public partial class Labor_ChonTinTuyenDung2 : System.Web.UI.Page
{
    ...
    {
        this.objTable = this.objTuyenDung.getDataTuVanXuatKhau(this.txtSearch.Value);
        cpTuyenDung.MaxPages = 1000;
        cpTuyenDung.PageSize = 15;
