...
public partial class Labor_XemDangKyViecLam : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            this.IDTuyenDung = int.Parse(Request.QueryString["id"].ToString());
        }
        catch
        {
            this.IDTuyenDung = 0;
    ...
    {
        this.objTable = this.objNguoiLaoDong.getDataNldGioiThieuByIDTuyenDung(this.IDTuyenDung);
