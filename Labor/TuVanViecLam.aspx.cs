...
public partial class Admin_TuVanViecLam : System.Web.UI.Page
{
    ...
    {
        this.objTable = this.objNguoiLaoDong.getDataTblNldTuVan();
        cpTuVanViecLam.MaxPages = 1000;
        cpTuVanViecLam.PageSize = 15;
