<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="TuVanViecLam.aspx.cs" Inherits="Admin_TuVanViecLam" %>
    ...
    <div style="width: 100%; margin-top:-20px;">
        <table class="DataListTableHeader" border ="0">
            <tr style ="height:40px;">
                ...
                <td class="DataListTableHeaderTdItemJustify" style="width: 46%;">Nội dung tư vấn
                </td>
                <td class="DataListTableHeaderTdItemJustify" style="width: 21%;">Lĩnh vực
                </td>
            ...
            <table class="DataListTable" border="0">
                <tr style ="height:40px;">
                    ...
                    <td class="DataListTableTdItemCenter" style="width: 3%;">
                        <a href="TuVanViecLamEdit.aspx?id=<%# Eval("TT") %>">
                            <img src="../Images/Edit.png" alt=""></a>
                    </td>
                    <td class="DataListTableTdItemCenter" style="width: 3%;">
                        <a href="TuVanViecLamDel.aspx?id=<%# Eval("TT") %>">
