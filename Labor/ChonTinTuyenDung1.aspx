<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ChonTinTuyenDung1.aspx.cs" Inherits="Labor_ChonTinTuyenDung1" %>
        ...
        <script type="text/javascript">
            function SetName(value1, value2) {
                if (window.opener != null && !window.opener.closed) {
                    var txtNameId = window.opener.document.getElementById("MainContent_txtIDDonVi1");
                    txtNameId.value = value1;

                    var txtName = window.opener.document.getElementById("MainContent_txtTenDonVi1");
