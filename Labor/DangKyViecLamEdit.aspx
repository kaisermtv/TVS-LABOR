                ...
                <table border="0" style="width: 100%;">
                    <tr>
                        ...
                        <td style="width: 20%;">
                            ...
                            <asp:TextBox ID="txtTenNguoiLaoDong" runat="server" CssClass="form-control" Style="width: 72% !important; float: left;"></asp:TextBox>
                            <button class="btn btn-primary" type="button" onclick="SelectName()" style="height: 34px !important; line-height: 14px !important; margin-left: 5px;">Chọn</button>
                        </td>
                        <td style="width: 8%; text-align: right; padding-right: 5px;">Tên công việc:</td>
                        <td style="width: 20%;">
                            <asp:TextBox ID="txtTenCongViec" runat="server" CssClass="form-control" Style="width: 100%"></asp:TextBox>
                        </td>
                        <td style="width: 8%; text-align: right; padding-right: 5px;">Vị trí:</td>
                        <td>
                            <asp:DropDownList ID="ddlIDChucVuDK" runat="server" Style="width: 50%;" CssClass="form-control">
                            </asp:DropDownList>
                        </td>
                        <td>&nbsp;
                        </td>
            ...
            <td colspan="6">
                <table border="0" style="width: 100%;">
                    <tr>
                        ...
                        <td style="width: 20%;">
                            <asp:DropDownList ID="ddlMucLuong" AutoPostBack="true" runat="server" CssClass="form-control" Style="width: 100%;">
                            </asp:DropDownList>
                        </td>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlIDHuyen" AutoPostBack="true" runat="server" CssClass="form-control" Style="width: 50%;">
                            </asp:DropDownList>
                        </td>
                        <td>&nbsp;
                        </td>
            ...
            <td colspan="5">
                <table border="0" style="width: 100%;">
                    <tr>
                        ...
                        <td style="width: 60%;">
                            <asp:CheckBox ID="ckbNuocNgoai" runat="server" Style="font-weight: normal;" />
            ...
            <td colspan="6">
                <table border="0" style="width: 100%;">
                    <tr>
                        ...
                        <td style="width: 8%; text-align: right; padding-right: 5px;">Ngày giới thiệu:</td>
                        <td style="width: 20%;">
                            <div class='input-group date' id='datetimepicker3' style="margin-left: 0px; width: 160px !important;">
                                <input type='text' class="form-control" id="txtNgayGioiThieu" runat="server" />
                                <span class="input-group-addon">
                                    <span class="glyphicon glyphicon-calendar"></span>
                                </span>
                            </div>
                        ...
                        <td>
                            ...
                            <asp:TextBox ID="txtNameChucVu" runat="server" CssClass="form-control"></asp:TextBox>
                        </td>
                        <td>
                            <button class="btn btn-primary" type="button" onclick="ChonTinTuyenDung()" style="height: 34px !important; line-height: 14px !important; margin-left: 10px;" id="btnGioiThieuViecLam" runat="server"><%Response.Write(this.strBtnViecLamTrongNuoc); %></button>
                        </td>
                    </tr>
                </table>
            </td>
