<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KinhNghiemLamViec.aspx.cs" Inherits="Admin_KinhNghiemLamViec" %>
...
<body style="margin: 0px !important; height: 500px !important;">
    ...
    <form id="form1" runat="server">
        <div style="width: 100%;">
            <table class="DataListTableHeader" border="0">
                <tr style="height: 40px;">
                    ...
                    <td class="DataListTableHeaderTdItemJustify" style="width: 15%;">Chức vụ
                    </td>
                ...
                <tr style="height: 40px;">
                    ...
                    <td class="DataListTableHeaderTdItemJustify">
                        <asp:DropDownList ID="ddlIDLinhVuc" AutoPostBack="true" runat="server" Style="width: 100%; height: 30px; line-height: 30px;">
                        </asp:DropDownList>
                    </td>
                    <td class="DataListTableHeaderTdItemJustify">
                        <asp:DropDownList ID="ddlChucVu" AutoPostBack="true" runat="server" Style="width: 100%; height: 30px; line-height: 30px;">
                        </asp:DropDownList>
                    </td>
        ...
        <asp:DataList ID="dtlNldKinhNghiem" runat="server" RepeatDirection="Horizontal" RepeatColumns="1"
            Width="100%">
            <ItemTemplate>
                <table class="DataListTable" border="0">
                    <tr style="height: 40px;">
                        ...
                        <td class="DataListTableTdItemJustify" style="width: 31%;">
                            <a href = "?id=<%# Eval("IDNguoiLaoDong") %>&idKN=<%# Eval("IDNldKinhNghiem") %>"><%# Eval("Donvi") %>
                        </td>
        ...
        <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-top: 5px; background-color: #fbf4f4; height: 26px;"
            ...
            <tr>
                <td style="padding-left: 6px;">
                    <cc1:CollectionPager ID="cpNldKinhNghiem" runat="server" BackText="" FirstText="Đầu"
