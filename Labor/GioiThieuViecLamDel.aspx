<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="GioiThieuViecLamDel.aspx.cs" Inherits="Admin_GioiThieuViecLamDel" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="panel panel-default">
        <div class="panel-heading">
            <h3 class="panel-title">XÓA NỘI DUNG GIỚI THIỆU VIỆC LÀM</h3>
        </div>
        <br />
        <br />
